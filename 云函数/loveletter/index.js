  ...
  return [
    {
      ...
      content:
        ...
        '你可以对用户提到的事情进行文学加工——比如把一句简短的回忆扩展成更细腻的画面，补充合理的情感和氛围描写，让文字更有温度。' +
        '但不要凭空捏造用户完全没有提到的事件或回忆。加工是围绕用户说的事情展开，而不是编造新的故事。' +
        '\n\n写作要求：' +
        '1. 语言质朴，句式偏短，可以带一点文言的温润（"展信安康""勿念"），但不要满篇文言；' +
        '2. 在用户原意的基础上润色措辞、调整语序、补充过渡和情感描写，让文字更像一封手写家书；' +
